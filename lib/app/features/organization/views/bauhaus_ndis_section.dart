...
class _BauhausNDISectionState extends ConsumerState<BauhausNDISection> {
  ...
  void initState() {
    ...
    _registrationNumberController = TextEditingController(text: widget.organization.ndisRegistration?.registrationNumber ?? '');
  }
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.verified, color: BauhausDesign.primary, size: 24),
                      ),
                  ...
                  child: Row(
                    children: [
                      Container(
                        width: 32,
                        height: 32,
                        color: _isRegistered ? BauhausDesign.success : BauhausDesign.neutral,
                        child: Icon(
                          _isRegistered ? Icons.check_circle : Icons.radio_button_unchecked,
                          color: BauhausDesign.textDark,
                          size: 20,
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              _isRegistered ? 'NDIS REGISTERED' : 'NOT NDIS REGISTERED',
                              style: GoogleFonts.inter(
                      ...
                      Switch(
                        ...
                        activeTrackColor: BauhausDesign.success.withOpacity(0.5),
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            filled: true,
                            fillColor: _isRegistered ? Colors.white : BauhausDesign.neutral.withOpacity(0.1),
                      ...
                      _BauhausSecondaryButton(
                        ...
                        onPressed: _isSaving 
                            ...
                            : () {
                                ...
                                _registrationNumberController.text = widget.organization.ndisRegistration?.registrationNumber ?? '';
                              },
                      ),
                    ],
                  ),
...
class _BauhausNDISatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final registrationNumber = organization.ndisRegistration?.registrationNumber;
      ...
      child: Column(
        ...
        children: [
          Container(
            padding: const EdgeInsets.all(BauhausDesign.space4),
            decoration: BoxDecoration(
              color: isRegistered ? BauhausDesign.success : BauhausDesign.neutral,
              border: Border(
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        height: 16,
                        decoration: BoxDecoration(
                          color: hasRegistrationNumber ? BauhausDesign.success : BauhausDesign.neutral,
                          border: Border.all(color: BauhausDesign.neutral, width: 1),
                        ),
