...
_OrganizationIntegrations _$OrganizationIntegrationsFromJson(
  ...
  quickbooks: json['quickbooks'] == null
      ? null
      : IntegrationConfig.fromJson(json['quickbooks'] as Map<String, dynamic>),
  ...
  salesforce: json['salesforce'] == null
      ? null
      : IntegrationConfig.fromJson(json['salesforce'] as Map<String, dynamic>),
  ...
  webhooks: json['webhooks'] == null
      ? null
      : IntegrationConfig.fromJson(json['webhooks'] as Map<String, dynamic>),
);
