...
class AdminOnboardingListView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminOnboardingListView> createState() => _AdminOnboardingListViewState();
}

class _AdminOnboardingListViewState extends ConsumerState<AdminOnboardingListView> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() => 
                ...
                : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      onTap: () {
                        ref.read(adminOnboardingViewModelProvider.notifier).selectUser(item);
