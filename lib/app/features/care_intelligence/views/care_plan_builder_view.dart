...
class _CarePlanBuilderViewState extends ConsumerState<CarePlanBuilderView> {
  ...
  void _loadData() {
    ...
    if (orgId != null) {
      ref
          .read(carePlanViewModelProvider.notifier)
          .generateCarePlan(clientId: clientId, organizationId: orgId);
      ref
          .read(carePlanViewModelProvider.notifier)
          .generateSmartGoals(clientId: clientId, organizationId: orgId);
    }
  }
                ...
                children: [
                  ...
                  if (state.goals.isEmpty)
                    const BauhausEmptyState(
                      ...
                      message: 'Tap generate to create AI-powered SMART goals.',
