...
class _CommunicationHubDashboardState
    ...
    if (widget.userId != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        if (widget.organizationId != null) {
          ...
          ref
              .read(communicationViewModelProvider.notifier)
              .loadBroadcastHistory(widget.organizationId!);
        }
      });
    }
  }
                  ...
                  SizedBox(
                    ...
                    child: BauhausActionButton(
                              ...
                              if (mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      success
                                          ? '$_selectedChannel sent and logged!'
                                          : 'Logged offline/Failed to log',
                                    ),
                      ...
                      text: state.isSending
                          ? 'SENDING...'
                          : 'SEND $_selectedChannel',
                      icon: _selectedChannel == 'SMS'
                          ? Icons.sms
                          : _selectedChannel == 'Email'
                          ? Icons.email
                          : Icons.send,
                ...
                child: BauhausCard(
                  child: ListTile(
                    ...
                    trailing: BauhausIconButton(
                      ...
                      onPressed: () =>
                          setState(() => _messageController.text = t.content),
  ...
  Widget _buildBroadcastTab(CommunicationState state) {
    ...
    final active = state.activeBroadcasts
      ...
      child: Column(
        ...
        children: [
          ...
          if (state.broadcastHistory.isNotEmpty) ...[
            ...
            ...state.broadcastHistory.map(
              (b) => _CommsBroadcastHistoryTile(broadcast: b),
            ),
          ],
        ],
      ),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Row(
                          children: ['announcement', 'reminder', 'update'].map((
                            t,
                          ) {
                            final sel = type == t;
                            return Expanded(
