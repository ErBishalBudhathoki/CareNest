...
final leaveBalancesProvider = FutureProvider.family<LeaveBalance?, String>((
  ref,
  email,
) async {
...
final leaveForecastProvider =
    AsyncNotifierProvider<LeaveForecastNotifier, Map<String, dynamic>?>(
      LeaveForecastNotifier.new,
    );
