  ...
  static bool isValidBase64Image(String? imageString) {
    ...
    try {
      ...
      if (decodedData.length < 500) {
        debugPrint(
          'ImageUtils: Image too small (${decodedData.length} bytes), likely a placeholder',
        );
        return false;
      }
...
class ImageErrorHandler {
  ...
  static Widget buildLoadingWidget({double size = 50.0, Color? surfaceColor}) {
    return Container(
      width: size,
      height: size,
      decoration: BoxDecoration(
