...
class SecureErrorHandler {
  ...
  static const String _genericNetworkError =
      'Network error. Please check your connection and try again.';
  static const String _genericServerError =
      'Service temporarily unavailable. Please try again later.';
  static const String _genericValidationError =
  ...
  static Map<String, dynamic> createAuthErrorResponse(dynamic error) {
    final sanitizedMessage = sanitizeErrorMessage(
      error,
