...
class _BauhausDateRangePickerState extends State<BauhausDateRangePicker> {
  ...
  void initState() {
    ...
    if (_rangeStart != null) {
      if (_rangeStart!.isBefore(widget.firstDate)) _rangeStart = widget.firstDate;
  ...
  void _parseDate(String value, {required bool isStart, bool updateControllers = true}) {
              ...
              child: Container(
                ...
                child: TableCalendar(
                  ...
                  headerStyle: HeaderStyle(
                    ...
                    leftChevronIcon:
                        const Icon(Icons.chevron_left, color: neutralColor),
                    rightChevronIcon:
                        const Icon(Icons.chevron_right, color: neutralColor),
                  ...
                  calendarStyle: CalendarStyle(
                    ...
                    withinRangeTextStyle: const TextStyle(
                        color: neutralColor, fontWeight: FontWeight.bold),
                    defaultTextStyle: const TextStyle(
                        color: neutralColor, fontWeight: FontWeight.w600),
                  ...
                  Expanded(
                    child: _buildButton(
                      ...
                      onPressed: () {
                        ...
                        _parseDate(_startController.text,
                            isStart: true, updateControllers: false);
                        _parseDate(_endController.text,
                            isStart: false, updateControllers: false);
