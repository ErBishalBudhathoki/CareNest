    ...
    animationController =
        AnimationController(
          ...
          ..addListener(() {
            ...
            double waveWidth =
                Math.pi / 240; // Lower frequency for gentler waves
            ...
            if (wavePoints.isNotEmpty &&
                wavePoints.last.dx < widget.size.width) {
              double finalPrimary = Math.sin(
                (widget.size.width * waveWidth) + waveSpeed,
              );
              double finalSecondary =
                  Math.sin(
                    (widget.size.width * waveWidth * 1.3) + (waveSpeed * 0.7),
                  ) *
                  0.3;
