...
@JsonKey(name: '_id') String get id; String get organizationId; String get userId; String? get clientId; DateTime get date; String get startLocation; String get endLocation; double get distance; String get tripType;// 'BETWEEN_CLIENTS', 'WITH_CLIENT', 'COMMUTE'
 String get status;// 'PENDING', 'APPROVED', 'REJECTED'
 String? get adminApprovalStatus; bool get isReimbursable; bool get isBillable;// Joined fields
...
@useResult
$Res call({
@JsonKey(name: '_id') String id, String organizationId, String userId, String? clientId, DateTime date, String startLocation, String endLocation, double distance, String tripType, String status, String? adminApprovalStatus, bool isReimbursable, bool isBillable, EmployeeInfo? employee
});
...
/// Create a copy of Trip
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? organizationId = null,Object? userId = null,Object? clientId = freezed,Object? date = null,Object? startLocation = null,Object? endLocation = null,Object? distance = null,Object? tripType = null,Object? status = null,Object? adminApprovalStatus = freezed,Object? isReimbursable = null,Object? isBillable = null,Object? employee = freezed,}) {
...
as DateTime,startLocation: null == startLocation ? _self.startLocation : startLocation // ignore: cast_nullable_to_non_nullable
...
as String?,isReimbursable: null == isReimbursable ? _self.isReimbursable : isReimbursable // ignore: cast_nullable_to_non_nullable
as bool,isBillable: null == isBillable ? _self.isBillable : isBillable // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String organizationId,  String userId,  String? clientId,  DateTime date,  String startLocation,  String endLocation,  double distance,  String tripType,  String status,  String? adminApprovalStatus,  bool isReimbursable,  bool isBillable,  EmployeeInfo? employee)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Trip() when $default != null:
return $default(_that.id,_that.organizationId,_that.userId,_that.clientId,_that.date,_that.startLocation,_that.endLocation,_that.distance,_that.tripType,_that.status,_that.adminApprovalStatus,_that.isReimbursable,_that.isBillable,_that.employee);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String organizationId,  String userId,  String? clientId,  DateTime date,  String startLocation,  String endLocation,  double distance,  String tripType,  String status,  String? adminApprovalStatus,  bool isReimbursable,  bool isBillable,  EmployeeInfo? employee)  $default,) {final _that = this;
switch (_that) {
case _Trip():
return $default(_that.id,_that.organizationId,_that.userId,_that.clientId,_that.date,_that.startLocation,_that.endLocation,_that.distance,_that.tripType,_that.status,_that.adminApprovalStatus,_that.isReimbursable,_that.isBillable,_that.employee);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '_id')  String id,  String organizationId,  String userId,  String? clientId,  DateTime date,  String startLocation,  String endLocation,  double distance,  String tripType,  String status,  String? adminApprovalStatus,  bool isReimbursable,  bool isBillable,  EmployeeInfo? employee)?  $default,) {final _that = this;
switch (_that) {
case _Trip() when $default != null:
return $default(_that.id,_that.organizationId,_that.userId,_that.clientId,_that.date,_that.startLocation,_that.endLocation,_that.distance,_that.tripType,_that.status,_that.adminApprovalStatus,_that.isReimbursable,_that.isBillable,_that.employee);case _:
  return null;
...
class _Trip implements Trip {
  const _Trip({@JsonKey(name: '_id') required this.id, required this.organizationId, required this.userId, this.clientId, required this.date, required this.startLocation, required this.endLocation, required this.distance, required this.tripType, required this.status, this.adminApprovalStatus, this.isReimbursable = false, this.isBillable = false, this.employee});
...
@override@JsonKey() final  bool isReimbursable;
@override@JsonKey() final  bool isBillable;
// Joined fields
@override final  EmployeeInfo? employee;
...
@override $EmployeeInfoCopyWith<$Res>? get employee;
...
/// Create a copy of Trip
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? organizationId = null,Object? userId = null,Object? clientId = freezed,Object? date = null,Object? startLocation = null,Object? endLocation = null,Object? distance = null,Object? tripType = null,Object? status = null,Object? adminApprovalStatus = freezed,Object? isReimbursable = null,Object? isBillable = null,Object? employee = freezed,}) {
  return _then(_Trip(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,organizationId: null == organizationId ? _self.organizationId : organizationId // ignore: cast_nullable_to_non_nullable
as String,userId: null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EmployeeInfo&&(identical(other.firstName, firstName) || other.firstName == firstName)&&(identical(other.lastName, lastName) || other.lastName == lastName)&&(identical(other.email, email) || other.email == email));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EmployeeInfo&&(identical(other.firstName, firstName) || other.firstName == firstName)&&(identical(other.lastName, lastName) || other.lastName == lastName)&&(identical(other.email, email) || other.email == email));
}
